    ...
    <div id="pjax-container">
        ...
        <div class="row central">
            ...
            while ($list = mysqli_fetch_array($resImg)) {
                ?>
                <idv
                    class="img_card col-lg-4 col-md-6 col-sm-12 col-sm-x-12 <?php if ($text['Animation'] == "1") { ?>animated slideInUp delay-03s<?php } ?>">
                    <div class="love_img">
                        <img class="<?php if ($text['Animation'] == "1") { ?>animated zoomIn delay-03s<?php } ?>"
